...
***
  ...
  + Group Presentation
    ...
    + Creating a module and presenting it over zoom because you got sick.
...
In short, I accomplished all of the tasks I was asked to accomplish on time.  
  ...
  + HW5: Boots for Days!  Difficult and not perfect.  Maybe a bit of a reprieve from the two before. Done on time. 
  ...
  + Group Presentation.  We just presented this yesterday, but I am proud of how it turned out.  I started from zero knowlledge of ctmm, and now feel as though I could use and explain it to others. 
